/*
 * electric_pulse_mcp - Model Context Protocol server for Electric Pulse.
 *
 ...
 *   claude mcp add --transport stdio electric_pulse -- /path/to/bin/electric-pulse-mcp
 */
...
static void handle_tools_list(yyjson_val *id)
{
    ...
    t = add_tool_def(doc, tools, "electric_pulse_inspect_abc",
        "Parse an ABC song through the Electric Pulse engine and return its full "
    ...
    t = add_tool_def(doc, tools, "electric_pulse_render_stats",
    ...
    t = add_tool_def(doc, tools, "electric_pulse_validate_abc",
    ...
    t = add_tool_def(doc, tools, "electric_pulse_pitch_resolve",
    ...
    t = add_tool_def(doc, tools, "electric_pulse_chord_tones",
    ...
    t = add_tool_def(doc, tools, "electric_pulse_duration_calc",
    ...
    t = add_tool_def(doc, tools, "electric_pulse_engine_caps",
...
/* ============================================================
 *   tool: electric_pulse_inspect_abc
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_render_stats
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_validate_abc
 * ============================================================ */

static int write_tmp_abc(const char *content, size_t len, char *path_buf, size_t buf_len)
{
    snprintf(path_buf, buf_len, "/tmp/electric-pulse-mcp-validate-%d-%ld.abc",
...
/* ============================================================
 *   tool: electric_pulse_list_demos
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_directive_help
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_duration_calc
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_pitch_resolve
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_chord_tones
 * ============================================================ */
...
/* ============================================================
 *   tool: electric_pulse_engine_caps
 * ============================================================ */
...
static void handle_tools_call(yyjson_val *id, yyjson_val *params)
{
    ...
    if (strcmp(n, "electric_pulse_inspect_abc") == 0)         tool_inspect_abc(id, args);
    else if (strcmp(n, "electric_pulse_render_stats") == 0)   tool_render_stats(id, args);
    else if (strcmp(n, "electric_pulse_validate_abc") == 0)   tool_validate_abc(id, args);
    else if (strcmp(n, "electric_pulse_pitch_resolve") == 0)  tool_pitch_resolve(id, args);
    else if (strcmp(n, "electric_pulse_chord_tones") == 0)    tool_chord_tones(id, args);
    else if (strcmp(n, "electric_pulse_list_demos") == 0)     tool_list_demos(id, args);
