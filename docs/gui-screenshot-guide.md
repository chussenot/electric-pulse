# Electric Pulse GUI Screenshot Guide
...
```sh
EFRAME_SCREENSHOT_TO=<target.png> xvfb-run -a cargo run -- --screenshot
```
...
- Env:
  - `ELECTRIC_PULSE_GUI_BOOT_DEMO=dark_moroder`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=browser`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=demos`
  - `ELECTRIC_PULSE_GUI_BOOT_RENDER=1`

### 2) Arrangement Edit Mode
- File: `docs/screenshots/gui-edit-mode-arrangement.png`
- Env:
  - `ELECTRIC_PULSE_GUI_BOOT_DEMO=dark_moroder`
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=arrangement`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=pattern-editor`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=instrument`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=fx`
...
- Env:
  - `ELECTRIC_PULSE_GUI_BOOT_DEMO=dark_moroder`
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=preview`
  - `ELECTRIC_PULSE_GUI_BOOT_FOCUS=waveform`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_PATTERN_EDITS=1`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_DIALOG=save-as`
...
- Env:
  ...
  - `ELECTRIC_PULSE_GUI_BOOT_EDITABLE=duplicate`
  - `ELECTRIC_PULSE_GUI_BOOT_MODE=edit`
  - `ELECTRIC_PULSE_GUI_BOOT_DIALOG=open`
