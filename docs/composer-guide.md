...
This guide focuses on authored retro-synth composition with the Electric Pulse ABC DSL.
...
- Validate often with `mise run play-demo` and `mise run render-demos`.
