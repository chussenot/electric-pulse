# Electric Pulse Audio ABC DSL

Electric Pulse parses ABC into `AbcMusic`, converts that into `SeqSong` with `abc_build_seq_song()`, and renders through the shared sequencer/mixer/FX path.
