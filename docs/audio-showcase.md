...
Use `mise run render-demos` to render the showcase catalog through the public audio engine API.

Use `mise run play-demo name` for single-track iteration.

Optional WAV export for sharing/listening:

- `mise run play-demo neon_nightdrive wav`
