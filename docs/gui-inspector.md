...
- Browser mode: `src/ffi.rs` overview structs (`TrackOverview`, `FxBusOverview`)
- Edit/Preview: `EditableSong` instrument/fx structures in `src/editor/model.rs`
