# Electric Pulse GUI Song Workflow
...
- **Editable user songs**: saved to `~/.local/share/electric_pulse/music/user/` by default (`XDG_DATA_HOME` and `ELECTRIC_PULSE_USER_SONG_DIR` are supported).
