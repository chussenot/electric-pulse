...
static const char *g_preset_names[ELECTRIC_PULSE_PRESET_COUNT] = {
    "electric_pulse_bass_pulse",
    "electric_pulse_dark_arp",
    "electric_pulse_soft_pad",
    "electric_pulse_brass_stab",
    "electric_pulse_lead",
    "electric_pulse_kick",
    "electric_pulse_hat",
    "electric_pulse_noise_snare"
};

static const SeqInstrument g_presets[ELECTRIC_PULSE_PRESET_COUNT] = {
    [ELECTRIC_PULSE_PRESET_BASS_PULSE] = {
...
static const SeqSong g_menu_song = {
    .title = "Electric Pulse Built-in Retro Sequencer",
    .tempo_bpm = 120,
    .swing_pct = 54,
    .steps_per_beat = 4,
    .instrument_count = ELECTRIC_PULSE_PRESET_COUNT,
    .instruments = {
        [ELECTRIC_PULSE_PRESET_BASS_PULSE] = {
    ...
    .patterns = {
        {
            ...
            .tracks = {
                {
                    .instrument = ELECTRIC_PULSE_PRESET_BASS_PULSE,
                    .steps = {
                ...
                {
                    .instrument = ELECTRIC_PULSE_PRESET_DARK_ARP,
                ...
                {
                    .instrument = ELECTRIC_PULSE_PRESET_LEAD,
                    .steps = {
                ...
                {
                    .instrument = ELECTRIC_PULSE_PRESET_HAT,
                    .steps = {
        ...
        },
        {
            ...
            .tracks = {
                ...
                {
                    .instrument = ELECTRIC_PULSE_PRESET_BRASS_STAB,
                    .steps = {
                        REST_STEP,        REST_STEP,        REST_STEP,        REST_STEP,
                ...
                {
                    .instrument = ELECTRIC_PULSE_PRESET_KICK,
                    .steps = {
...
{
    if (count) *count = ELECTRIC_PULSE_PRESET_COUNT;
    return g_presets;
}

const char *audio_builtin_instrument_preset_name(int index)
{
    if (index < 0 || index >= ELECTRIC_PULSE_PRESET_COUNT) return "";
